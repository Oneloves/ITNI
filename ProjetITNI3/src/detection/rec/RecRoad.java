...
// LEFT PART    	
    	...
    	HoughRec houghLeftHorizontal = new HoughRec(image.m_imageArraySobelLeftBlue, 10, m_width, m_height, 2, 85, 95, 1, 2);
    	...
    	HoughRec houghLeftVertical = new HoughRec(image.m_imageArraySobelLeftBlue, 10, m_width, m_height, 2, 0, 10, 2, 1);
...
// RIGHT PART
    	// Hough transform left line
    	HoughRec houghRightHorizontal = new HoughRec(image.m_imageArraySobelRightBlue, 10, m_width, m_height, 2, 85, 95, 1, 2);
    	...
    	// Hough transform right line
    	HoughRec houghRightVertical = new HoughRec(image.m_imageArraySobelRightBlue, 10, m_width, m_height, 2, 0, 10, 2, 1);
