...
public class FramePicture extends JFrame {
	...
	JPanel panel;
	ImagePanel panel1 = new ImagePanel("Résultat");
	ImagePanel panel2 = new ImagePanel("Selection sur les teintes");
	ImagePanel panel3 = new ImagePanel("Sobel");
	ImagePanel panel4 = new ImagePanel("Original découpé");
	//ImagePanel panel5 = new ImagePanel("Selection sur les teintes");
	...
	public void setPanels(File[] files, int i) {
		new Thread(){
			public void run(){
				...
				//panel5.setImage(image.test4);
				panel4.setImage(image.test3);
			}
		}.start();
	}
}
