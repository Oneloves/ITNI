...
public class TriangleRoad {
	...
	//LEFT PART    	
		...
		Line houghLeftHorizontal = new Line(image.m_imageArraySobelLeftRed, 27, m_width, m_height, 1, 85, 95);
		m_imageArrayImageLeftDownLine = houghLeftHorizontal.process();

		// Hough transform left line
		Line houghLeftVertical = new Line(image.m_imageArraySobelLeftRed, 27, m_width, m_height, 1, 17, 27);
		...
		Line houghLeftHorizontal2 = new Line(m_imageArrayImageLeftRightLine, 27, m_width, m_height, 1, 17, 27);
	...
	//RIGHT PART
		// Hough transform down line
		Line houghRightHorizontal = new Line(image.m_imageArraySobelRightRed, 27, m_width, m_height, 1, 85, 95);
		m_imageArrayImageRightDownLine = houghRightHorizontal.process();

		// Hough transform left line
		Line houghRightVertical = new Line(image.m_imageArraySobelRightRed, 27, m_width, m_height, 1, 17, 27);
		...
		Line houghRightHorizontal2 = new Line(m_imageArrayImageRightRightLine, 27, m_width, m_height, 1, 17, 27);
